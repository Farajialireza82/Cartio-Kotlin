...
import com.cromulent.cartio.ui.component.common.ListEmptyState
import com.cromulent.cartio.ui.component.common.ListPageTopBar
import com.cromulent.cartio.ui.component.row.ShopItemRow
import com.cromulent.cartio.ui.component.dialog.ConfirmDialog
import com.cromulent.cartio.ui.screen.shop.list.ListPageUiMode.*
        ...
        Column(
            ...
            Box(
                ...
                androidx.compose.animation.AnimatedVisibility(
                    visible = state.shopItems.isEmpty() && state.uiMode != LOADING,
                    ...
                    LazyColumn(
                        ...
                        items(
                            ...
                            AnimatedShopItem(
                                ...
                                isSelectionMode = state.uiMode == SELECTING,
                            )
                        }
                    }
                }
